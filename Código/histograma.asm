# Código em assembly do histograma

.data

colunas: .word 64   # Número de colunas da imagem
linhas:  .word 81   # Número de linhas da imagem
vmaximo: .word 255  # Maior valor de itensidade de cinza
                    # Lembrar que o intervalo [0, 255]
H:      .space 1024
...
main:
    ...
    inicioForH: # Inicio do vetor para preencher H com zeros. for(int i=0; i<256; i++)
        ...
        forH:
            sw $zero, 0($s1) # Adiciona zero a posição atual do vetor.
